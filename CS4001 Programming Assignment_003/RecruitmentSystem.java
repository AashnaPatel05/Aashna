...
public class RecruitmentSystem {
    ...
    public RecruitmentSystem() {
        ...
        addLabel("Vacancy Number:", 40, 40);
        txtVacancyNumber = addTextField(150, 40);
        
        addLabel("Job Type:", 40, 120);
        txtJobType = addTextField(150, 120);
        
        addLabel("Staff Name:", 40, 180);
        txtStaffName = addTextField(150, 180);
        
        addLabel("join Date:",40, 220);
        txtjoinDate = addTextField(150, 220);
        
        addLabel("Appointed By:", 40, 260);
        txtAppointedBy = addTextField(150, 260);
    ...
    private void setFullTimeSalary() {
        try {
            ...
            JOptionPane.showMessageDialog(frame, "Full-Time staff with given vacancy number not found.");
        } catch (Exception ex) {
    ...
    private void setPartTimeshifts() {
        try {
            ...
            JOptionPane.showMessageDialog(frame, "Part-Time Staff with given vacancy number not found.");
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(frame, "Invalid input for shift");
        }
    }
        ...
        try {
                ...
                JOptionPane.showMessageDialog(frame, "No matching Part-Time staff found");
            } catch (Exception ex) {
